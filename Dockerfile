...
RUN PATH=$PATH:/runtime; /runtime/fix_bb; cd /; mkdir /host; mkdir /cross; cd /host; make -j 4 -f /runtime/Makefile.host all; /cd /cross; make -j 4 -f /runtime/Makefile.cross ${PKG}; mv /cross/${PKG} /packages; rm -rf /host /runtime /cross
