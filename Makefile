...
$(xxm)init$(txz):
	$(fetch); mkdir $(xxm)init; cd $(xxm)init; \
	    ...
	    chmod +x busybox; \
	    echo '{"all": "mkdir xbin; ./busybox --install xbin; PATH=xbin/:$PATH"}' > setup.json; \
